...
namespace MacroFit.Areas.Identity.Pages.Account
{
    public class RegisterProgressModel : PageModel
    {
        private readonly MacroFitContext _context;
        private readonly IHostEnvironment _environment;

        public RegisterProgressModel(MacroFitContext context, IHostEnvironment environment)
        {
            _context = context;
